              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'bg-aa-orange/10 text-aa-orange'
            ...
            <div className="p-4 rounded-lg bg-aa-dark-600">
              <div className="flex items-center gap-2 mb-2">
                {session?.user?.creatorId ? (
                  <>
                    ...
                    <span className="text-sm font-medium text-white">TikTok Connected</span>
                  </>
                ) : (
                  <>
                    <AlertCircle className="w-4 h-4 text-aa-orange" />
              ...
              {!session?.user?.creatorId && (
                <Link
                  ...
                  className="text-xs text-aa-orange hover:underline"
                >
                  Connect to access products →
                </Link>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center justify-between h-full px-4 lg:px-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                className="hidden sm:flex items-center gap-2 px-4 py-2 bg-[#5865F2]/10 text-[#5865F2] rounded-lg hover:bg-[#5865F2]/20 transition-colors"
              >
        ...
        {isPending && (
          <div className="bg-aa-orange/10 border-b border-aa-orange/20 px-4 lg:px-8 py-3">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-aa-orange">
                Your account is pending approval. You'll have full access once approved by an admin.
              </p>
            </div>
          </div>
        )}
